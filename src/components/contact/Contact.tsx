...
const Contact = () => {
  return (
    <div className="my-20 px-6">
      ...
      <div className="flex flex-col my-8 space-y-4">
        <div className="flex items-center space-x-4">
          ...
          <p className="text">
            ...
            <span className="underline">processing of your personal data</span>
          </p>
        </div>
        <div className="flex items-center space-x-4">
          <input
      ...
      <button className="border text w-[211px] py-6 px-10 rounded-full h-fit hover:border-none hover:bg-highlight">submit</button>
      </div>
    </div>
  );
};
